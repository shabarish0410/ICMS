...
class Settings(BaseSettings):
    ...
    # CORS
    CORS_ORIGINS: str = "http://localhost:3000,http://localhost:5173,http://127.0.0.1:3000,https://icms-topaz.vercel.app,https://icms-2ykq.onrender.com,https://spark-innovation.onrender.com"
