...
const styles = StyleSheet.create({
  ...
  countdownOverlay: { position: 'absolute', inset: 0, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' },
  countdownText: { color: 'white', fontSize: 72, fontWeight: 'black' },
  successOverlay: { position: 'absolute', inset: 0, backgroundColor: 'rgba(16,185,129,0.5)', justifyContent: 'center', alignItems: 'center' },
