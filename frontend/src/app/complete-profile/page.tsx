...
function CompleteProfileContent() {
  const { user, completeProfile, changePassword, requestChangePasswordOtp, verifyChangePasswordOtp } = useAuth();
  ...
  const [pwdStep, setPwdStep] = useState<'request' | 'verify' | 'password'>('request');
